...
console.print(Panel.fit("[bold magenta]DÉMARRAGE DU PIPELINE ETL :  DATASET 2024 (ADVANCED)[/bold magenta]", border_style="cyan"))
...
# Liste des datasets à fusionner avec leurs variables utiles
datasets = [
...
# Tableau de suivi qualité fusion
...
for file_rel_path, cols in track(datasets, description="[cyan]Traitement des fichiers...[/cyan]"):
    ...
    if path.exists():
        ...
        # UTILISATION DE LA FONCTION  POUR NETTOYER LE CODE INSEE
...
console.print("\n")
console.print(Panel(rapport, title="[bold magenta]PIPELINE RÉUSSI[/bold magenta]", border_style="green"))