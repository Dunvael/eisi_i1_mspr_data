...
def calculer_chomage_par_age():
    ...
    print("Isolement de la population en âge de travailler (15-64 ans)...")
    ...
    # On garde uniquement les tranches actives (15-64 ans)
    tranches_actives = {
    ...
    # Calcul des volumes projetés 2022 → 2024 par tranche
    ...
    for tranche, (col_h, col_f, coeff) in tranches_actives.items():
        ...
        # Population active totale 15-64
    ...
    # Agrégation après fusions communes
    ...
    # Filtrage catégorie ABC + année + total population
    df_dares = df_dares[
    ...
    # chômeurs manquants → médiane départementale
    ...
    # nettoyage valeurs aberrante
    df_final.loc[df_final['taux_chomage_15_64'] > 60, 'taux_chomage_15_64'] = np.nan
    
    
    # 6. Imputation du Taux de Chômage Final (Médiane Départementale)
